'Units
Global tera As Double, giga As Double, mega As Double, kilo As Double, milli As Double, micro As Double, nano As Double, pico As Double, femt As Double
...
Dim VTH As Double, GAMMA As Double, AGS As Double, IMAXG0 As Double, IMAXG1 As Double, VGIMAX As Double, BGS As Double, NDR As Double
Dim IMAXD0 As Double, IMAXD1 As Double, VDIMAX As Double, BDS As Double
Dim VSAT0 As Double, VSAT1 As Double, VSAT2 As Double, VVSAT As Double, VVSAT2 As Double, BVSAT As Double, BVSAT2 As Double
Dim IDR0 As Double, IDR1 As Double, Gamma2 As Double, IVGST0 As Double, IMAXG2 As Double, KAPPA As Double, NGR As Double, IMAXD2 As Double
...
Dim VTO_EE As Double, GAMMA_EE As Double, VCH_EE As Double, VDELT_EE As Double, VDSO_EE As Double, VSAT_EE As Double, KAPA_EE As Double
Dim VTSO_EE As Double, GMMAX_EE As Double, VGO_EE As Double, VCO_EE As Double, MU_EE As Double, VBA_EE As Double, VBC_EE As Double, DELTGM_EE As Double
Dim ALPHA_EE As Double, ISG_EE As Double, NF_EE As Double, KBK_EE As Double, IDSOC_EE As Double, VBR_EE As Double, NBR_EE As Double, PEFF_EE As Double
...
Dim vds As Double, vgs As Double, vgd As Double
    ...
    ggdgd = dfn7z("Ids", level, vds, vgs, vgd, 0.001, 1)
...
Dim vds As Double, vgs As Double, vgd As Double
    ...
    ggdgd = dfn7y("Ids", level, vds, vgs, vgd, 0.001, 1)
...
Dim vds As Double, vgs As Double, vgd As Double
    ...
    ggdgd = dfn7x("Ids", level, vds, vgs, vgd, 0.001, 1)
...
Function tanh(x As Double) As Double
    tanh = (expm(x) - expm(-x)) / (expm(x) + expm(-x))
End Function
...
'                     EEHEMT1 model
'=======================================================
Sub EEHEMT1(ByVal vdsx As Double, ByVal vgsx As Double, vgdx As Double, Ids_eeh As Double, gds_eeh As Double, gm_eeh As Double)
Dim vds As Double, vgs As Double, vgd As Double
Dim a_eeh As Double, b_eeh As Double, bp1_eeh As Double, gammvdso_eeh As Double, gdsocomp_eeh As Double, gdsvvb_eeh As Double
Dim gdsx_eeh As Double, gm_eeh As Double, gmo_eeh As Double, gmocomp_eeh As Double, gmoff_eeh As Double, gmvb_gmoff_eeh As Double
Dim gmvvb_eeh As Double, gmx_eeh As Double, Ids_eeh As Double, Idso_eeh As Double, Idsocomp_eeh As Double, Idsvvb_eeh As Double
...
Dim vsat3_eeh As Double, vt_eeh As Double, vx_eeh As Double, vxgctg_eeh As Double, wg_ugw_eeh As Double, wuikt_eeh As Double
            ...
            Else:  'vgs > vt_eeh And vgs <= vg_eeh Then
...
Dim Ids_eeh As Double, gds_eeh As Double, gm_eeh As Double

    Call EEHEMT1(vdsx, vgsx, vgdx, Ids_eeh, gds_eeh, gm_eeh)
    EEHEMT1_Ids = Ids_eeh
...
Dim vc_eeh As Double, dv_eeh As Double, valp_eeh As Double, vsq_eeh As Double
